...
window.addEventListener("load", () => {
    ...
    let designSquare = document.querySelector(".design-square1");
     if(translateElement.innerHTML === ""){
         ...
         designSquare.style.height = "173vw"
